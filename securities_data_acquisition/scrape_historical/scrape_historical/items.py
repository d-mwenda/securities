...
class SEItem(scrapy.Item):
    ...
    price = scrapy.Field(input_processor=MapCompose(convert_to_float),
                         output_processor=TakeFirst())
...
class MystockKeItem(scrapy.Item):
    ...
    closing_price = scrapy.Field(input_processor=MapCompose(convert_to_float),
                                 output_processor=TakeFirst())
    high_price = scrapy.Field(input_processor=MapCompose(convert_to_float),
                              output_processor=TakeFirst())
    low_price = scrapy.Field(input_processor=MapCompose(convert_to_float),
                             output_processor=TakeFirst())
    volume = scrapy.Field(input_processor=MapCompose(strip_comma,
...
class KENSEItem(scrapy.Item):
    ...
    company_name = scrapy.Field(input_processor=MapCompose(
                                ...
                                output_processor=TakeFirst())
    ISIN_CODE = scrapy.Field(input_processor=MapCompose(process_isin_code),
                             output_processor=TakeFirst())
